...
const skills = [
'Portfolio Optimization', 'Asset Allocation', 'Risk Management',
'Macro & Microeconomic Analysis', 'Financial Modeling', 'Risk Modeling',
'Traditional Equities', 'Bonds', 'Cryptocurrencies', 'Derivatives',
...
export function Skills() {
  ...
  useLayoutEffect(() => {
    const calculateWidth = () => {
      ...
      const totalWidth = skills.length * roleWidth
